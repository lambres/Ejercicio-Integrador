...
namespace Entidades
{
    ...
    public class Paciente
    {
        ...
        public Paciente(string nombre, string apellido, string dni, string mail, string telefono, string fechaConsulta, string horario, EObraSocial obraSocial, ETipoConsulta tipoConsulta)
        {
            this.Nombre = nombre;
